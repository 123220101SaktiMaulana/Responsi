...
//    
   ...
   public void insertDosen() {
        try {
            ...
            */
            ...
            String nidn = halamanInput.getInputNo_hp();
             ...
             */
            if ("".equals(nama) || "".equals(nidn) || "".equals(email)) {
   ...
   public void EditDosen(int id){
       try {
                ...
                String nidn = halamanEdit.getInputNo_hp();
                String email = halamanEdit.getInputEmail();

                if ("".equals(nama) || "".equals(nidn)) {
                    throw new Exception("Nama dan lainnya tidak boleh kosong!");
                }
                
                Dosendiedit.setId(id);
                Dosendiedit.setNama(nama);
                Dosendiedit.setNo_hp(nidn);
